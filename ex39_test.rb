...
cities = Dict.new()
Dict.set(cities, 'CA', San Franisco)
...
# puts some states
puts '-' * 10
puts "Michigan's abbreviaton is: #{Dict.get(states, 'Michigan')}"
puts "Florida's abbreviaton is: #{Dict.get(states, 'Florida')}"
